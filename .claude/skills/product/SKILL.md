---
skill_name: recruitment-agency-pm
version: 1.0.0
description: Product management expertise for recruitment agency software, covering ATS features, candidate workflows, client management, and industry-specific requirements for yacht crew and luxury household staff recruitment.
author: Cedric
created: 2025-01-03
---
...
## Overview
This skill provides Claude with deep expertise in managing recruitment agency software products, specifically for agencies in the yacht crew and luxury household staff sectors. It covers applicant tracking systems (ATS), candidate relationship management (CRM), workflow automation, and industry-specific requirements.
...
|---------|------------|--------------|--------------|----------------|
| AI Matching | ✓ Semantic | ✗ | ✓ Keyword | Quality of matches |
| Mobile App | ✓ PWA | ✓ Native | ✗ | Time to market |
| Client Portal | ✓ Full | ✓ Limited | ✓ Full | UX simplicity |
...
A recruitment agency product is successful when:
