...
export const POSITION_CATEGORIES: Record<string, PositionCategory> = {
  yachtCrew: {
    ...
    positions: [
      ...
      { slug: "first-officer", label: "First Officer", popular: true },
      { slug: "bosun", label: "Bosun" },
      { slug: "deckhand", label: "Deckhand", popular: true },
      { slug: "chief-engineer", label: "Chief Engineer", popular: true },
      { slug: "engineer", label: "Engineer" },
      { slug: "chief-stewardess", label: "Chief Stewardess", popular: true },
      { slug: "stewardess", label: "Stewardess", popular: true },
