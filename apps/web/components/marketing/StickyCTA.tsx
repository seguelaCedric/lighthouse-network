...
import { Ship, Users, ArrowRight, X } from "lucide-react";
        ...
        <div className="flex flex-1 items-center justify-center gap-3 sm:flex-none sm:justify-end">
          <Link href="/job-board" className="flex-1 sm:flex-none">
            <Button size="sm" className="w-full sm:w-auto">
              ...
              <span className="hidden sm:inline">See Open Positions</span>
          ...
          <Link href="/hire" className="flex-1 sm:flex-none">
            <Button variant="secondary" size="sm" className="w-full sm:w-auto">
              ...
              <span className="hidden sm:inline">Hire Crew & Staff</span>
