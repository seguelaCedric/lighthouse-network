...
const allPositions = [
  ...
  { value: "second_engineer", label: "Second Engineer", category: "yacht" },
  { value: "third_engineer", label: "Third Engineer", category: "yacht" },
  { value: "eto", label: "ETO", category: "yacht" },
  { value: "chief_stewardess", label: "Chief Stew", category: "yacht" },
  { value: "second_stewardess", label: "Second Stew", category: "yacht" },
  { value: "third_stewardess", label: "Third Stew", category: "yacht" },
  { value: "stewardess", label: "Stew", category: "yacht" },
