...
import type { BriefStatus } from "../../../../packages/database/types";
...
export function DashboardClient({
  ...
  const navItems: NavItem[] = [
    { id: "dashboard", label: "Dashboard", icon: <LayoutDashboard className="size-5" />, href: "/dashboard", active: true },
    { id: "briefs", label: "Briefs", icon: <FileText className="size-5" />, href: "/briefs", badge: stats.newBriefsCount > 0 ? stats.newBriefsCount : undefined },
    { id: "jobs", label: "Jobs", icon: <Briefcase className="size-5" />, href: "/jobs", badge: stats.openJobsCount > 0 ? stats.openJobsCount : undefined },
