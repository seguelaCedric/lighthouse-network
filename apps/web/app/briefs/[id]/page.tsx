...
import type { Brief, BriefStatus, CommChannel, BriefParsedData } from "../../../../../../packages/database/types";
...
export default function BriefDetailPage() {
  ...
  const navItems: NavItem[] = [
    ...
    { id: "briefs", label: "Briefs", icon: <FileText className="size-5" />, href: "/briefs", active: true },
