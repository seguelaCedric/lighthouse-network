  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="mb-2 flex gap-2">
              ...
              {user.photo && (
                <Button variant="secondary" size="sm" className="text-burgundy-600 hover:text-burgundy-700">
      ...
      <div className="rounded-xl border border-burgundy-200 bg-burgundy-50 p-6">
        ...
        <Button variant="secondary" className="border-burgundy-300 text-burgundy-700 hover:bg-burgundy-100">
          Delete Account
        </Button>
      </div>
    </div>
